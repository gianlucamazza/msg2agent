...
export default function SignupForm() {
  ...
  const tabs: {
    ...
    { plan: "free", label: "Free", price: "$0/mo" },
    {
      plan: "starter",
      label: "Starter",
      price: paidEnabled ? "$19/mo" : "Coming soon",
      disabled: !paidEnabled,
    },
    {
      plan: "team",
      label: "Team",
      price: paidEnabled ? "$99/mo" : "Coming soon",
      disabled: !paidEnabled,
    },
  ];
    ...
    <div class="form-section">
      <div class="plan-tabs">
        {tabs.map((t) => (
          <div
            ...
            onClick={() => {
              if (!t.disabled) setSelectedPlan(t.plan);
            }}
      ...
      {bannerEmail && (
        <div class="no-account-banner">
          <p>
            No account found for <strong>{bannerEmail}</strong>. Create one
            below.
          </p>
        </div>
      )}
      ...
      {checkoutUrl && (
        <div class="checkout-msg" style="margin-top: 1.5rem">
          <p>
            ...
            <br />
            If you aren't redirected, <a href={checkoutUrl}>click here</a>.
          </p>
        </div>
      )}
    </div>
